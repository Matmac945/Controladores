...
void setup() {
  //create .ino file
  outputFile = createWriter("StaticTest/StaticTest.ino");

  //save ".vm" file in arrays
  String[][] lines = new String[][]{
    loadStrings("StaticsTest/Sys.vm"), 
    loadStrings("StaticsTest/Class1.vm"), 
    loadStrings("StaticsTest/Class2.vm")
  };
      ...
      if (currentLineParts[0].equals("push")) {
        ...
        if (currentLineParts[1].equals("static")) {
          if (i == 0) {
            ...
            outputFile.println("memory[sp++] = memory[_static + " + currentLineParts[2] + Stat[i-1] + "];");
            staticVar++;
          }
        }
      ...
      if (currentLineParts[0].equals("pop")) {     
        ...
        if (currentLineParts[1].equals("static")) {
          if (i == 0) {
            ...
            outputFile.println("memory[_static + " + currentLineParts[2] + Stat[i-1] + "] = memory[sp-1];");
            outputFile.println("sp--;");
          }
        }
        if (currentLineParts[1].equals("this")) {
